...
using GitSimple.UI.Services;
using Microsoft.AspNetCore.Components;
using Microsoft.AspNetCore.Components.Web;

namespace GitSimple.UI.Components.NaturalLanguage;

public partial class NLCommandBar : ComponentBase
{
    ...
    {
        Bridge.OnFocusNLBar += async () => await InvokeAsync(async () =>
        {
            // Focus is handled by JS, but we can trigger state
            StateHasChanged();
        });
    }
    ...
    private async Task TranslateInput()
    {
        ...
        {
            _translation = new NLTranslation("", $"Error: {ex.Message}", RiskLevel.Safe, false, null, null, "error");
        }
